...
const ProductDetails = () => {
  ...
  return (
    <Helmet title={productName}>
      <CommanSection title={productName}/>
      <section>
        <Container>
          <Row>
            <Col lg='6'>
            ...
            <Col lg='6'>
              <div className="product__details">
                ...
                <div className="product__rating d-flex align-items-center gap-5 mb-4">
                  ...
                  <div className='d-flex ratingsdiv'>(<span style={{color:'coral'}}>{avgRating}</span> <span className='ratings'>ratings</span>)</div>
                </div>
              ...
              <span>Category : {category.toUpperCase()}</span>
                ...
                <motion.button whileTap={{scale:1.2}}  style={{color:'white'}} className="buy__btn" onClick={addToCart}>Add to Cart</motion.button>
              </div>
            </Col>
          </Row>
        </Container>
                  ...
                  <div className="review__form">
                    ...
                    <form action="" onSubmit={submitHandler}>
                      <div className="form__group">
                        <input type="text" placeholder='Enter a name' ref={reviewUser} required/>
                      </div>
                      ...
                      <motion.button whileTap={{scale:1.2}}  style={{color:'white '}} type='submit' className='buy__btn'>Submit</motion.button>
                    </form>
                  </div>
                </div>
              </div>)
